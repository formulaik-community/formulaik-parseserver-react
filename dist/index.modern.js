...
var WhereSingle = (function (props) {
  ...
  var validationSchema = function validationSchema() {
    return object().shape({
      fieldName: string().required("This field can't be blank"),
      constraint: string().required("This field can't be blank"),
      value: string().required("This field can't be blank")
    });
  };
...
var ParseQuery = (function (props) {
  ...
  return /*#__PURE__*/React.createElement(Accordion, {
    ...
    className: "w-full justify-center flex"
  }, /*#__PURE__*/React.createElement(CircularProgress, null)) : /*#__PURE__*/React.createElement("div", {
    className: "w-full"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("b", null, "Query"), /*#__PURE__*/React.createElement(ReactJson, {
    src: query.toJSON(),
    collapsed: true,
    enableClipboard: false
  })) : null, query && queryResult ? /*#__PURE__*/React.createElement("div", {
    className: "mt-2 text-xs text-warmGray-600 italic w-full"
  }, /*#__PURE__*/React.createElement("b", null, "Results (count: " + queryResult.count + ")"), /*#__PURE__*/React.createElement(ReactJson, {
...
var VisualSelectForParseRef = (function (props) {
  ...
  if (!refs) {
    ...
    }, /*#__PURE__*/React.createElement("h4", null, "Loading"));
  }
...
var ParseObjectUniqueValue = (function (props) {
  ...
  var initialValue = useRef(data.value);
...
var parseUserAutoComplete = (function (props) {
  ...
  return /*#__PURE__*/React.createElement(ParseObjectAutoComplete, _props);
});
